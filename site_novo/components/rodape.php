...
<div class="footer-legal text-center" style="background:#144397">
  <div class="container d-flex flex-column flex-lg-row justify-content-center justify-content-lg-between align-items-center">
    ...
    <div class="d-flex flex-column align-items-center align-items-lg-start">
      <div class="copyright">
      <span style="color:#fff;font-size:18px;text-align:center;font-weight:bold;font-style:italic">UNIDADE CIDADE NOVA</span>
<span style="color:#fff">Rua Prof. felix Valois, 61<br> Cidade nova</span>

<span style="color:#fff;font-size:18px;text-align:center;font-weight:bold;font-style:italic">UNIDADE MANOA</span>
<span style="color:#fff">Av. Francisco Queiroz, 02 -Cidade nova</span>
