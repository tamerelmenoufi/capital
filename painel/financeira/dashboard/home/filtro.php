                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex justify-content-between">
                      <div class="p-2" style="font-size:12px;"><i class="fa-solid fa-user"></i> <?=(($d->nome)?:"<span style='color:text-danger'>Sem Identificação</span>")?></div>
                      <div class="p-2" style="font-size:12px;"><i class="fa-solid fa-id-card"></i> <?=(($d->cpf)?:"<span style='color:text-danger'>000.000.000-00</span>")?></div>
                    </div>
                    <div class="d-flex justify-content-between">
