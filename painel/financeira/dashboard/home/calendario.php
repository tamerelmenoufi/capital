<?php
    ...
    $query = "select * from sisLog where data like '{$year}-".str_pad($month, 2, "0", STR_PAD_LEFT)."%' and tabela in ('clientes', 'CONSULTAS_LOG') and sessao->>'$.codUsr' > 0 group by registro->>'$.codUsr'";
