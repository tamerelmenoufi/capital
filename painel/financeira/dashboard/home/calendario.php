<?php
    ...
    $query = "select * from sisLog where data like '{$year}-".str_pad($month, 2, "0", STR_PAD_LEFT)."%' and tabela in ('clientes', 'CONSULTAS_LOG') and registro->>'$[0]' > 0 group by registro->>'$[0]'";
