...
<div class="anexos">
    <div class="row">
        <div class="col">
            <div class="d-flex justify-content-center align-items-center flex-column botao_anexo" style="background-color:rgba(var(--bs-success-rgb), 1)">
        ...
        <div class="col">
            <div class="d-flex justify-content-center align-items-center flex-column botao_anexo" style="background-color:rgb(var(--bs-success-rgb), 1)">
