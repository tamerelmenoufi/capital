        ...
        <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
          ...
          <div class="row g-0 portfolio-container">
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-app<?=$d->categoria?>">
              <img src="<?=$localPainel?>volume/portifolio/<?=$d->imagem?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><?=$d->titulo?></h4>
                <a href="<?=$localPainel?>volume/portifolio/<?=$d->imagem?>" title="<?=$d->titulo?>" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
